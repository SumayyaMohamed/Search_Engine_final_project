...
if st.button("Search"):
    ...
    # Simulated database
    df_30_percent_data = pd.read_csv("C:/Users/Downloads/df_30_percent_data.csv")  # Replace "your_data.csv" with the actual file path
    database = df_30_percent_data['Movies/Series'].tolist()
